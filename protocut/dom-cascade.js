...
DomCascade.prototype = {
    ...
    options: {
        ...
        click:     function( ob, res ) { var node = res.node; node.addEventListener( 'click'    , lang.hitch( ob, ob.click     ) ); },
        mouseover: function( ob, res ) { var node = res.node; node.addEventListener( 'mouseover', lang.hitch( ob, ob.mouseover ) ); },
        mouseout:  function( ob, res ) { var node = res.node; node.addEventListener( 'mouseout' , lang.hitch( ob, ob.mouseout  ) ); },
        js: function( ob, res ) {
            var node = res.node;
            var func = ob.js;
            func( ob, res );
